...
class MembershipController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $membership = membershipModel::create([
                'user_id' => auth()->user_id(), // Authenticated user ka ID
                'brand_id' => $request->brand_id,
                'brand_name' => $request->brand_name,
                'brand_logo_url' => $request->brand_logo_url,
                'coupon_title_tab1' => $request->coupon_title_tab1,
            ...
            return response()->json([
                'success' => true,
                'message' => 'Membership successfully create ho gaya.',
                'data' => $membership,
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Membership create nahi hua',
                'error' => $e->getMessage(),
            ], 500);
        }
    }
